              ...
              if (isEdgeElement(datum)) {
                  if (tag == 'path' || tag == 'polygon') {
                      ...
                      if (prevStartNode) {
                          ...
                          // }
                          datum.offset = {
                              x: startShape && startShape.center ? (prevStartShape.center.x - startShape.center.x) : 0,
                              y: startShape && startShape.center ? (prevStartShape.center.y - startShape.center.y) : 0,
                          }
                      }
                  }
              }
